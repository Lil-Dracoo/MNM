                    ...
                    <ul>
                        ...
                        <li><a href="#"><i class="fa fa-user"></i> <span>Quản Lý Tài Khoản</span></a>
                            <ul class="side-header-sub-menu">
                               ...
                               <?php if (isset($_SESSION['user']) && $_SESSION['user1']['vai_tro'] == 2): ?>
                        <li>
                        ...
                        <?php if ($_SESSION['user1']['vai_tro'] ==2){ ?>
                            <li class="has-sub-menu"><a href="#"><i class="fa fa-line-chart" ></i> <span>Theo Dõi Doanh Thu</span></a>
                                <ul class="side-header-sub-menu">
                                    <li><a href="index.php?act=DTdh&&trang=1"><i class="fa fa-line-chart" ></i><span>Doanh Thu Phim</span></a></li>
                                    <li><a href="index.php?act=DTngay&&trang=1"><i class="fa fa-line-chart" ></i><span>Doanh Thu Theo Ngày</span></a></li>
                                    <li><a href="index.php?act=DTtuan&&trang=1"><i class="fa fa-line-chart" ></i><span>Doanh Thu Theo Tuần</span></a></li>
                                    <li><a href="index.php?act=DTthang&&trang=1"><i class="fa fa-line-chart" ></i><span>Doanh Thu Theo Tháng</span></a></li>
                                </ul>
                            </li>
                        <?php } ?>
